...
public class TestData
{
    ...
    public RaefTechUser Org1Admin1 { get; } = new()
    {
    ...
    public RaefTechUser Org1Admin2 { get; private set; } = null!;
    ...
    public RaefTechUser Org1User1 { get; private set; } = null!;
    public RaefTechUser Org1User2 { get; private set; } = null!;
    #endregion
    ...
    public RaefTechUser Org2Admin1 { get; } = new()
    {
    ...
    public RaefTechUser Org2Admin2 { get; private set; } = null!;
    ...
    public RaefTechUser Org2User1 { get; private set; } = null!;
    public RaefTechUser Org2User2 { get; private set; } = null!;
    #endregion
    ...
    public async Task Init()
    {
        ...
        using var scope = IoCActivator.ServiceProvider.CreateScope();
        using var userManager = scope.ServiceProvider.GetRequiredService<UserManager<RaefTechUser>>();
